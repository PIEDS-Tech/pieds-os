...
import { getContactById, updateContact, CONTACT_TYPES, CONTACT_STATUSES, syncContactWithOrganization } from "@/lib/contacts-store";
...
export default function EditContactPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Get current contact to find old org ID for unlinking
      const currentContact = getContactById(id);
      const oldOrgId = currentContact
        ? organizations.find((o) => o.name === currentContact.organization)?.id
        : undefined;
      ...
      // Auto-sync to organization
      syncContactWithOrganization(id, formData.organization, oldOrgId);
